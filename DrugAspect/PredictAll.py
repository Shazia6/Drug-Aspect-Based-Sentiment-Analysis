...
#Set Random seed
np.random.seed(500)
var = input("Please enter review effectiveness rating sideEffects: ")
...
Test_X_Tfidf = Tfidf_vect.transform([var])
...
print("Naive Bayes Prediction -> "+str(predictions_NB))
...
# Use accuracy_score function to get the accuracy
print("SVM Prediction -> "+str(predictions_NB))

clf_random_forest = RandomForestClassifier()
clf_random_forest.fit(Train_X_Tfidf, Train_Y)
# predict the labels on validation dataset
predictions_Random= clf_random_forest.predict(Test_X_Tfidf)

# Use accuracy_score function to get the accuracy
print("Random Forest Prediction -> "+str(predictions_Random))